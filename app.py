    ...
    with tab5:
        ...
        with col1:
            ...
            if run_a:
                ...
                st.caption(
                    f"🖥️ Topology: {run_a.metadata.prefill_workers}P/{run_a.metadata.decode_workers}D"
                )
        ...
        with col2:
            ...
            if run_b:
                ...
                st.caption(
                    f"🖥️ Topology: {run_b.metadata.prefill_workers}P/{run_b.metadata.decode_workers}D"
                )
